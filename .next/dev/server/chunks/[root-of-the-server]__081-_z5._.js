...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://usmcbbmffieyxymvlbjh.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_BJRY6plrmzWfangSFUIfVg_2uzExtWZ"), {
        cookies: {
            getAll () {
    ...
    if (!isPublic && !user && !request.nextUrl.pathname.startsWith("/login") && !request.nextUrl.pathname.startsWith("/auth")) {
...
const hasEnvVars = ("TURBOPACK compile-time value", "https://usmcbbmffieyxymvlbjh.supabase.co") && ("TURBOPACK compile-time value", "sb_publishable_BJRY6plrmzWfangSFUIfVg_2uzExtWZ");
}),
...
async function proxy(request) {
    // Bypass authentication for API routes so Thunder Client can test them
...
//# sourceMappingURL=%5Broot-of-the-server%5D__081-_z5._.js.map